 ...
 */
package org.pfred.table.simpletable;
...
import org.pfred.sort.COMPARABLE_COMAPRATOR;
import org.pfred.sort.DATE_COMPARATOR;
import org.pfred.sort.LEXICAL_COMPARATOR;
import org.pfred.sort.NUMERIC_TEXT_COMPARATOR;
...
public class SimpleTableSorter extends AbstractTableModel {
    ...
    private HashMap comparatorsCache = new HashMap();
    ...
    public SimpleTableSorter(TableModel tableModel) {
        this();
        setTableModel(tableModel);
    }

    public SimpleTableSorter(TableModel tableModel, JTableHeader tableHeader) {
        this();
    ...
    protected Comparator getComparator(int column) {
      ...
      if (comparatorsCache.get(columnType)!=null ){
        return (Comparator) comparatorsCache.get(columnType);
      }
        ...
        if (comparator != null) {
          comparatorsCache[column]= comparator;
            return comparator;
        }*/
           ...
           columnType.equals(Integer.class) )
        {
         ...
         comparatorsCache.put(columnType, numericalTextComparator);
        ...
        if (Comparable.class.isAssignableFrom(columnType)) {
          ...
          comparatorsCache.put(columnType, comparableComparator);
    ...
    private class TableModelHandler implements TableModelListener {
        public void tableChanged(TableModelEvent e) {
            ...
            if (e.getFirstRow() == e.getLastRow()
                ...
                fireTableChanged(new TableModelEvent(SimpleTableSorter.this,
                                                     viewIndex, viewIndex,
                                                     column, e.getType()));
                return;
            }
      ...
      /*  public Component getTableCellRendererComponent(JTable table,
        ...
        public Component getTableCellRendererComponent(JTable table,
        	...
        	if (c instanceof JLabel) {
        		...
        		if (numRowsAllowed <= 0) numRowsAllowed = 1;
        		...
        		for (int i = 0; i < folds; i++) {
        			...
        			if (i > 0) htmltext.append("<br>");
        			htmltext.append(chars, i * charsPerRow, numChars);
        		}

        		if (exceeded) htmltext.append("...");
