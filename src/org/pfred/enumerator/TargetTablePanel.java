...
public class TargetTablePanel extends JPanel implements TableModelListener, ActionListener {
  ...
  public TargetTablePanel(String[] targetData, String delim, int id_colIdx, int length_colIdx) throws Exception{//exception when there are data format problem in targetData
